...
export const rule = createRule({
    meta: {
        type: 'problem',
        docs: {
            description: 'Require @Component decorators to have encapsulation: ViewEncapsulation.None',
        },
        messages: {
            missingViewEncapsulationNone: '@Component must have encapsulation: ViewEncapsulation.None.',
            wrongViewEncapsulation: '@Component encapsulation must be ViewEncapsulation.None. Found: {{ found }}.',
        },
        schema: [],
    },
    ...
    create(context) {
        return {
            Decorator(node) {
                ...
                const encapsulationProp = configArg.properties.find((prop) => prop.type === AST_NODE_TYPES.Property &&
                ...
                const isViewEncapsulationNone = value.type === AST_NODE_TYPES.MemberExpression &&
