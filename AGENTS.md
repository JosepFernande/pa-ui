...
| `github-issues-from-docs` | crear issue, GitHub issue, US-XX, revisar issue, alinear issue con documentación. Crear y revisar issues de GitHub alineados con documentación técnica usando cache híbrido de GitHub Wiki en Engram.                               | [`skills/github-issues-from-docs/SKILL.md`](skills/github-issues-from-docs/SKILL.md) |
| `pa-ui-release`           | hacer un release, publicar a npm, por qué no se publicó, trabajar con `.changeset/`, revisar el workflow `release.yml`. Checklist operativo del pipeline de release y validación de paquetes antes del publish (validate-packages). | [`skills/pa-ui-release/SKILL.md`](skills/pa-ui-release/SKILL.md)                     |
