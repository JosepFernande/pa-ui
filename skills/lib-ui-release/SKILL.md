...
longer exists. The library's pre-#139 npm scope shipped `core`, `button`,
`input`, and an `angular` umbrella package with their last stable versions (e.g.
`core@19.3.1`) under that scope before the rename;
